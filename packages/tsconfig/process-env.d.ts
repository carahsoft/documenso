declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_SIGNING_ENABLE_LTV?: string;
    ...
    NEXT_PRIVATE_SIGNING_AZURE_KEY_VAULT_URL?: string;
    NEXT_PRIVATE_SIGNING_AZURE_KEY_NAME?: string;
    NEXT_PRIVATE_SIGNING_AZURE_CERTIFICATE_NAME?: string;
    NEXT_PRIVATE_SIGNING_AZURE_TENANT_ID?: string;
    NEXT_PRIVATE_SIGNING_AZURE_CLIENT_ID?: string;
    NEXT_PRIVATE_SIGNING_AZURE_CLIENT_SECRET?: string;
    NEXT_PRIVATE_SIGNING_AZURE_CERTIFICATE_PATH?: string;
    NEXT_PRIVATE_SIGNING_AZURE_CERTIFICATE_CONTENTS?: string;
    NEXT_PRIVATE_SIGNING_AZURE_CERTIFICATE_CHAIN_PATH?: string;
    NEXT_PRIVATE_SIGNING_AZURE_CERTIFICATE_CHAIN_CONTENTS?: string;
